...
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/energy_avg/ensemble_EVV_type1' + '.txt')
...
for i in range(10):
    ...
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/energy_avg/ensemble_EVV_type2' + '.txt')
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel(r'$ \|\| u\|\|^2$')
plt.legend(loc='lower right')
...
for i in range(10):
    ...
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/energy_avg/ensemble_penalty_EVV_evvtype1_evv1type1' + '.txt')
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel(r'$ \|\| u\|\|^2$')
plt.legend(loc='lower right')
...
for i in range(10):
    ...
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/energy_avg/ensemble_penalty_EVV_evvtype2_evv1type1' + '.txt')
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel(r'$ \|\| u\|\|^2$')
plt.legend(loc='lower right')
...
for i in range(10):
    ...
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/divu_avg/ensemble_EVV_type1' + '.txt')
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel(r'$ \|\| \nabla\cdot u\|\|^2$')
plt.legend(loc='lower right')
...
for i in range(10):
    ...
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/divu_avg/ensemble_EVV_type2' + '.txt')
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel(r'$ \|\| \nabla\cdot u\|\|^2$')
plt.legend(loc='lower right')
...
for i in range(10):
    ...
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/divu_avg/ensemble_penalty_EVV_evvtype1_evv1type1' + '.txt')
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel(r'$ \|\|\nabla\cdot u\|\|^2$')
plt.legend(loc='lower right')
...
for i in range(10):
    ...
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/divu_avg/ensemble_penalty_EVV_evvtype2_evv1type1' + '.txt')
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel(r'$ \|\|\nabla\cdot u\|\|^2$')
plt.legend(loc='lower right')
...
for i in range(10):
    ...
    energy = energy * nu
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/enstropy_avg/ensemble_EVV_type1' + '.txt')
energy = energy * nu
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel('Enstropy')
...
for i in range(10):
    ...
    energy = energy * nu
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/enstropy_avg/ensemble_EVV_type2' + '.txt')
energy = energy * nu
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel('Enstropy')
...
for i in range(10):
    ...
    energy = energy * nu
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/enstropy_avg/ensemble_penalty_EVV_evvtype1_evv1type1' + '.txt')
energy = energy * nu
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel('Enstropy')
...
for i in range(10):
    ...
    energy = energy * nu
    plt.plot(x, energy, alpha=alpha_list[i], linewidth=linewidth_list[-i-1], color=color_map(i+1), label=label_list[i])
energy = np.loadtxt('/Users/boweiouyang/Desktop/femml/cylinder2/output/enstropy_avg/ensemble_penalty_EVV_evvtype2_evv1type1' + '.txt')
energy = energy * nu
plt.plot(x, energy, alpha=alpha_list[-1], linewidth=linewidth_list[0], color=color_map(14), marker='.', markevery=40, label=r'$ \langle u \rangle$')
plt.xlabel("t")
plt.ylabel('Enstropy')
